...
export function MagicCard({ children, className = "" }: MagicCardProps) {
  return (
    <div
      className={`relative overflow-hidden rounded-2xl border border-[var(--line)] bg-[var(--card)]/90 p-4 shadow-[0_14px_40px_rgba(30,64,175,0.08)] backdrop-blur ${className}`}
    >
